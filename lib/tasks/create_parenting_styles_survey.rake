...
task :create_parenting_styles_survey => :environment do
  ...
  question_3 = Survey::Question.new do |question|
    question.text = "Which of the following two descriptions sounds more like you?<new-paragraph><span>Thinking<span> parents trust logic, objectivity and impersonal analysis. They let children do for themselves, foster independence and answer children’s why’s in order to fuel their rational development. They struggle to tune in to and be patient with children’s irrational feelings.<new-paragraph><span>Feeling<span> parents rely on values, feelings and personal information to decide. They strive to be physically and emotionally close, attuned to children’s feelings, and go to great lengths to make them happy. Seeking family harmony, they struggle to say no and be firm if it may cause conflict.<new-paragraph>If you are still unsure here are more detailed descriptions of Thinkers vs Feelers"
    question.options = [
