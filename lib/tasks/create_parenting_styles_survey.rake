...
task :create_parenting_styles_survey => :environment do
  ...
  question_1 = Survey::Question.new do |question|
    ...
    question.first_category = "Extraverts"
    question.second_category = "Introverts"
    ...
    question.options = [
      Survey::Option.new(:text => "<span>Extraverted</span> parents are energized by going, doing, interacting and experiencing. They are typically “in the know” and get children out to experience the world. Too much time isolated at home can make them feel shaky and ungrounded. They are uncomfortable with a child who is more of a loner and needs a lot of solitude.", :weight => 1),
  ...
  question_2 = Survey::Question.new do |question|
    ...
    question.first_category = "Sensors"
    question.second_category = "Intuitives"
  ...
  question_3 = Survey::Question.new do |question|
    ...
    question.first_category = "Thinkers"
    question.second_category = "Feelers"
    ...
    question.options = [
      Survey::Option.new(:text => "<span>Thinking</span> parents trust logic, objectivity and impersonal analysis. They let children do for themselves, foster independence and answer children’s why’s in order to fuel their rational development. They struggle to tune in to and be patient with children’s irrational feelings.", :weight => 100),
      Survey::Option.new(:text => "<span>Feeling</span> parents rely on values, feelings and personal information to decide. They strive to be physically and emotionally close, attuned to children’s feelings, and go to great lengths to make them happy. Seeking family harmony, they struggle to say no and be firm if it may cause conflict.", :weight => 200)
    ]
  end
  ...
  question_4 = Survey::Question.new do |question|
    ...
    question.first_category = "Judgers"
    question.second_category = "Perceivers"
    ...
    question.options = [
      Survey::Option.new(:text => "<span>Judging</span> parents are intentional parents who like structure, plans, limits, and order. They are adept at organizing day-to-day living so kids feel secure and don’t miss out. They aim to get things done, on time, and in the right way, but struggle to adapt to the unexpected, relax and have fun.", :weight => 1000),
      Survey::Option.new(:text => "<span>Perceiving</span> parents take things as they come and keep their options open. They are flexible and spontaneous, and generally tolerant and accepting of children. They enjoy hanging out and can be relaxed about clutter, but struggle to do chores regularly and keep the house in order.", :weight => 2000)
    ]
  end
