...
task :create_parenting_styles_survey => :environment do
  ...
  question_1 = Survey::Question.new do |question|
    question.text = "Although you probably agree with some of each, which of these two descriptions sounds more like you? (Check Only One)<new-paragraph>Extraverted<span> parents are energized by going, doing, interacting and experiencing. They are typically “in the know” and get children out to experience the world. Too much time isolated at home can make them feel shaky and ungrounded. They are uncomfortable with a child who is more of a loner and needs a lot of solitude.<new-paragraph>Introverted<span> parents are energized by solitude and time alone. They are observant, reflective and prefer one-on-one interactions. They know their children as individuals and provide them with “downtime” to unwind and recharge. Drained by too much interaction, they must guard their energy to make it through the day without exploding.<new-paragraph>If you are still unsure here are more detailed descriptions of Extraverts vs Introverts"
    question.options = [
  ...
  question_3 = Survey::Question.new do |question|
    question.text = "Which of the following two descriptions sounds more like you?<new-paragraph>Thinking<span> parents trust logic, objectivity and impersonal analysis. They let children do for themselves, foster independence and answer children’s why’s in order to fuel their rational development. They struggle to tune in to and be patient with children’s irrational feelings.<new-paragraph>Feeling<span> parents rely on values, feelings and personal information to decide. They strive to be physically and emotionally close, attuned to children’s feelings, and go to great lengths to make them happy. Seeking family harmony, they struggle to say no and be firm if it may cause conflict.<new-paragraph>If you are still unsure here are more detailed descriptions of Thinkers vs Feelers"
    question.options = [
  ...
  question_4 = Survey::Question.new do |question|
    question.text = "Which of the following two descriptions sounds more like you? And remember, there is no wrong or right answer.<new-paragraph>Judging<span> parents are intentional parents who like structure, plans, limits, and order. They are adept at organizing day-to-day living so kids feel secure and don’t miss out. They aim to get things done, on time, and in the right way, but struggle to adapt to the unexpected, relax and have fun.<new-paragraph>Perceiving<span> parents take things as they come and keep their options open. They are flexible and spontaneous, and generally tolerant and accepting of children. They enjoy hanging out and can be relaxed about clutter, but struggle to do chores regularly and keep the house in order.<new-paragraph>If you are still unsure here are more detailed descriptions of Judgers vs Perceivers"
    question.options = [
